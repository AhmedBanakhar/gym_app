...
class UpDateAccount extends StatefulWidget {
  final member;
  const UpDateAccount({super.key, this.member});
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  ...
                                  //   "Member_Image": "$imagemem",
                                  // };
                                  if (imagemem == null) {
                                    databaseHelper.eidtdatamemberpassword(
                                        memberId, _passwordController.text);
                                    setState(() {});
                                  } else {
                                    if (imagemem != null) {
                                      databaseHelper.eidtdatamemberimage(
                                          memberId, imagemem!);
                                      setState(() {});
                                    }
                                  }
