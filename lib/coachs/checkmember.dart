...
class CheckMember extends StatefulWidget {
  var member_id;
  var member_name;
  CheckMember({super.key, this.member_id, this.member_name});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
            ...
            title: Text(widget.member_name)),
        body: FutureBuilder(
            future: databaseHelper
                .getDataMemberExaminationsforCoache(widget.member_id),
              ...
              return ListView.builder(
                  ...
                  itemBuilder: (context, i) {
                    return Card(
                        ...
                        child: Row(
                          children: [
                            if ((snapshot.data?[i]['Examination_image'] !=
                                null))
                              Row(
                                children: [
                                  InstaImageViewer(
